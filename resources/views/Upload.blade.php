...
<body>
    <div class="header" style="justify-content:space-between;">
        ...
        <div style="display:flex;gap:.5rem;">
            <a href="/dashboard"
                style="padding:.4rem .8rem;border-radius:8px;font-size:.8rem;font-weight:500;color:var(--muted);text-decoration:none;border:1px solid var(--border);transition:all .2s;"
                onmouseover="this.style.borderColor='var(--primary)';this.style.color='var(--text)'"
                onmouseout="this.style.borderColor='var(--border)';this.style.color='var(--muted)'">📊 Dashboard</a>
            <a href="/"
                style="padding:.4rem .8rem;border-radius:8px;font-size:.8rem;font-weight:500;color:var(--text);text-decoration:none;background:rgba(59,130,246,.1);border:1px solid rgba(59,130,246,.25);">📁
                Upload</a>
        </div>
    </div>
    <div class="container">
        <div id="alertSuccess" class="alert alert-success"><span class="msg"></span><span class="close-btn"
                onclick="this.parentElement.classList.remove('show')">&times;</span></div>
        <div id="alertError" class="alert alert-error"><span class="msg"></span><span class="close-btn"
                onclick="this.parentElement.classList.remove('show')">&times;</span></div>
            ...
            <div class="card">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" name="occupancy" id="occupancyInput" min="0" placeholder="e.g. 52"
                            oninput="calcOccupancyPct()">
                    </div>
                    <div class="form-group">
        ...
        <div class="card response-card" id="responseCard">
            ...
            <div style="margin-top:1rem;display:flex;gap:0.75rem;flex-wrap:wrap;">
                <a id="exportLink" class="btn btn-primary"
                    style="text-decoration:none;display:inline-flex;font-size:0.8rem;padding:0.5rem 1rem;">📥 Download
                    Excel</a>
                <a id="exportPdfLink" class="btn"
                    style="text-decoration:none;display:inline-flex;font-size:0.8rem;padding:0.5rem 1rem;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;border-radius:10px;font-weight:600;align-items:center;gap:0.4rem;transition:all 0.2s;"
                    onmouseover="this.style.transform='translateY(-1px)';this.style.boxShadow='0 8px 25px rgba(239,68,68,0.35)'"
                    onmouseout="this.style.transform='none';this.style.boxShadow='none'">📄 Download PDF</a>
            </div>
        </div>
    </div>
