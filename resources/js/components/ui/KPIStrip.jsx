...
export const KPIStrip = ({ mis, kpi, collection, isLoading }) => {
    ...
    const cards = [
        ...
        { label: 'Net Collection',  ftd: kpi?.net_collection,                            mtd: mis?.totals?.collection_mtd ?? null,  icon: Wallet,      color: 'cyan',   format: 'rupee' },
        ...
        { label: 'IP Census',       ftd: kpi?.bed_occupancy  ?? ftdVol.occupancy,        mtd: mtdVol.occupancy  ?? null,            icon: BedDouble,   color: 'violet', format: 'count' },
        { label: 'ER Patients',     ftd: kpi?.er_count       ?? ftdVol.er_count,         mtd: mtdVol.er_count   ?? null,            icon: HeartPulse,  color: 'red',    format: 'count' },
        ...
        { label: 'Surgeries',       ftd: kpi?.surgery_count  ?? ftdVol.surgery_count,    mtd: mtdVol.surgery_count ?? null,         icon: Scissors,    color: 'rose',   format: 'count' },
