...
export const misApi = {
    ...
    exportExcel:  (branch, date) => `/api/mis/${branch}/${date}/export`,
    exportPdf:    (branch, date) => `/api/mis/${branch}/${date}/export-pdf`,
    exportCsv:    (branch, date) => `/api/mis/${branch}/${date}/export-csv`,
