...
export const Sidebar = ({ isMobile = false }) => {
    ...
    // Mobile: translate animation (always 260px wide, slides in/out)
    // Desktop: width animation (icon strip ↔ full sidebar)
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-2.5 px-3 py-3.5 flex-shrink-0" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
                ...
                {/* On desktop: chevron toggle. On mobile: X close button */}
                {isMobile ? (
                    <button
